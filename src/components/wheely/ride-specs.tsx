...
export function RideSpecs({
  ...
  const metrics: {
    ...
    { Icon: Sunrise, sf: 'sunrise.fill', label: 'Sunrise', value: weather.sunrise ?? '—' },
    { Icon: Sunset, sf: 'sunset.fill', label: 'Sunset', value: weather.sunset ?? '—' },
  ];

  return (
    <View style={styles.metricsGrid}>
      {metrics.map(({ Icon, sf, label, value, qualifier, condition, iconRotation }) => (
          ...
          <View style={styles.metricLabelRow}>
            ...
            >
              {Platform.OS === 'ios' ? (
                ...
                <Icon size={18} color={c.mutedInk} strokeWidth={2} />
              )}
            </View>
